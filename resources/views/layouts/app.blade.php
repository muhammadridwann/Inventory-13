    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="{{ url('home') }}" class="logo">
                ...
                <span class="logo-lg"><b>INVENTORY </b>13</span>
            </a>
...
<footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; {!! date("Y") !!} <a href="http://ujian.smkn-13bdg.sch.id">SMKN 13 Bandung</a>.</strong> All rights reserved.
</footer>
